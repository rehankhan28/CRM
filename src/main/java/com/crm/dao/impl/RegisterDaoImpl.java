...
/*
 * create table customer_tab(email varchar(30)primary key,firstname
 * varchar(15),lastname varchar(15),password varchar(16),gender varchar(12),age
 * int,contactnumber bigint,dateofbirth date,country varchar(20));
 * 
 */
